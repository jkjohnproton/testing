...

{
	...
	$clsaxPersonalDoctor->submitted=1;

	if($clsaxPersonalDoctor->submitted==1){
		$clsaxPersonalDoctor->sortColumn = "personalDoctorReportId";
		$arrPersonalDoctorReports		= $clsaxPersonalDoctor->retrievePersonalDoctorArray();
	...
	include_once($includePath."templates/axPersonalDoctorReports.tmpl.php");
