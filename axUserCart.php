...
include_once($includePath."classes/axCart.cls.php");
...
$clsaxCart	= new clsaxCart($connect, $includePath);
$clsaxCart->setPostVars();
...
{
	global $arrPageRange,$clsaxPatient,$clsaxCart;
	...
	$arrCart = array();   
	$clsaxCart->userId = $_SESSION["AXUSERID"];
	$arrCart = $clsaxCart->retrieveCartArray();
	...
	include_once($includePath."templates/axUserCart.tmpl.php");
