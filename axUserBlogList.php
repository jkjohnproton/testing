...
{
	global $arrPageRange,$clsaxBlogs;
	
	$clsaxBlogs	= 	new clsaxBlogs($connect, $includePath);
	$clsaxBlogs	->	sortDirection = "ASC";
	$clsaxBlogs	->	postBlogs();
	$pageRange				= 	HTMLOptionKeyValArray($arrPageRange,$clsaxBlogs->pageSize);
	$arrBlogs			= 	array();
	...
	include_once($includePath."templates/axUserBlogList.tmpl.php");
