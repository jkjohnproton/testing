...
<!--<link rel="stylesheet" href="./template_assets/table_css/style.css">-->
...

{
	...
	$clsaxPersonalDoctor->setGetVars();
	...
	include_once($includePath."templates/axPersonalDoctor.tmpl.php");
