...
include_once($includePath."classes/axPersonalDoctor.cls.php");
...
{
	global $arrPageRange,$clsaxPersonalDoctor,$clsaxProduct,$clsaxPatient,$clsaxSubClients;
	
	
	$clsaxPersonalDoctor	= new clsaxPersonalDoctor($connect, $includePath);
	$clsaxPersonalDoctor->setPostVars();
	
	$clsaxPersonalDoctor->userId = $_SESSION["AXUSERID"];
	
	$clsaxPersonalDoctor->postPersonalDoctor();
	...
	$patientList = HTMLOption2DArray($arrPatient,"patientId","patientName",$clsaxPersonalDoctor->patientId);
	
	$clsaxPatient->sortDirection = "ASC";
	$clsaxPatient->retrieveFirstInsertedPatient($_SESSION["AXUSERID"]);
	
	$clsaxPatient->retrievePatient($clsaxPersonalDoctor->patientId);

	include_once($includePath."templates/axPayment.tmpl.php");
