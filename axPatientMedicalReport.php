...
$pageTitle			= (($clsaxUserMedicalReport->userId == "")?"Add":"Edit")." a Patient MedicalReport in ".getProductName();	
$metaDescription	= "";
$metaKeywords		= "";
?>
<!DOCTYPE html>
...

{
	...
	$clsaxPatient->returnUrl = "axUserMedicalReport.php";
	...
	include_once($includePath."templates/axPatientMedicalReport.tmpl.php");
