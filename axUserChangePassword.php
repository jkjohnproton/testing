...

{
	...
	$clsaxUser->userId = $_SESSION["AXUSERID"];
	
	if($clsaxUser->returnUrl == ""){
		
		$clsaxUser->returnUrl = "axUserDashboard.php";
		}
	...
	include_once($includePath."templates/axUserChangePassword.tmpl.php");
